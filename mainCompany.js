...
class Main extends React.Component {
    ...
    renderHeader() {
        ...
        source={{
          uri: 'https://i.pinimg.com/564x/aa/8d/46/aa8d4679b3b39e91b17cb4675ec0d60d--design-logo-gfx-design.jpg',
        ...
        return (
            <Block row card shadow color="white" style={styles.request} >
                ...
                <Block flex={0.75} column middle>
                    ...
                    <Button title='Resume' onPress={() => { Alert.alert("https://drive.google.com/file/d/171ohlFH-5kbTzAfHJij8BvFeENDj9VZI/view?usp=sharing", request.resume) }}></Button>
                </Block>
            </Block>
        );
    }
